...
st.set_page_config(
    page_title="Huber-Stephens Literature Expert",
    page_icon="\U0001F4DA",
    layout="wide",
...
def main():
    ...
    # Header
    st.markdown(
        '<div class="main-header">Huber-Stephens Literature Expert</div>',
        unsafe_allow_html=True,
    )
    st.markdown(
    ...
    with st.sidebar:
        ...
        st.markdown("### About")
        st.markdown("""
        This agent helps you query the Huber-Stephens
        research program on welfare states, state capacity,
        redistribution, and democracy through:
        - Semantic search across 30 works (1992-2025)
        - Citation-backed answers with full authorship
        - Literature synthesis
        - Research draft review
        - Interactive visualizations (concept maps, causal graphs)
        """)
...
ChromaDB: {settings.chromadb_path}
    ...
    with tab3:
        ...
        1. **Question Answering** -- Ask questions about the Huber-Stephens literature.
           Filter by year range. Get citation-backed answers with full authorship.
        ...
        5. **Visualizations** -- Generate interactive concept maps, causal graphs,
           and comparison diagrams from the literature.
        ...
        examples = [
            "What is the social democratic service state and how does it differ from the transfer state?",
            "How do Huber and Stephens conceptualize the relationship between partisan incumbency and welfare state generosity?",
            "What are the three power clusters in Capitalist Development and Democracy?",
            "How does Evans, Huber, and Stephens's concept of state effectiveness differ from state capacity?",
